...
resource "aws_lb_listener_rule" "main" {
  ...
  condition {
    host_header {
      values = [var.component == "frontend" ? "${var.env}.pavansai.online" : "${var.component}-${var.env}.pavansai.online"]
    }
  }
}
...
resource "aws_lb_listener_rule" "public" {
  ...
  condition {
    host_header {
      values = ["${var.env}.pavansai.online"]
    }
  }
}
    ...
    "Statement": [
      {
        ...
        "Resource": "arn:aws:ssm:us-east-1:678650345091:parameter/docdb.${var.env}.*"
      },
      {
        "Sid": "VisualEditor1",
        "Effect": "Allow",
